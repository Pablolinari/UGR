...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/copia
...
${OBJECTDIR}/estudiante/src/contraste.o: estudiante/src/contraste.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estudiante/src/contraste.o estudiante/src/contraste.cpp

${OBJECTDIR}/estudiante/src/subimagen.o: estudiante/src/subimagen.cpp
	${MKDIR} -p ${OBJECTDIR}/estudiante/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estudiante/src/subimagen.o estudiante/src/subimagen.cpp
