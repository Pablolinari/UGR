...
int p = num_items/NUMPRODUCTORAS;
int c = num_items/NUMCONSUMIDORAS;
int producidos[NUMPRODUCTORAS]={0};
...
int producir_dato(  int i )
{
   ...
   const int valor_producido = i*p + producidos[i];
   producidos[i]+=1;
   mtx.lock();
...
class ProdConsSU1 : public HoareMonitor
{
 ...
 int                        // variables permanentes
   ...
   primera_libre , primera_ocupada,          //   indice de celda de la próxima inserción ( == número de celdas ocupadas)
n;
...
int main()
{
   ...
   for (int i= 0; i< NUMPRODUCTORAS; i++) {
