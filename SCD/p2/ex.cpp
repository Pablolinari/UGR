...
int veces[num_fumadores]={0,0,0};
int cuenta[num_fumadores]={0,0,0};
...
void estanco::dormir(int i){
	cout<<"empieza a dormir el fumador "<< i<<endl;
	dormido[i].wait();
	cout<<"termina de dormir el fumador "<<i<<endl;
}
