/**
 *
 Código para multimplicación secuencial de matrices: m3 = m1 * m2
 pmm-secuencial.c
 *
 */
 ...
 * @return 0 upon exit success (print tiempo de cálculo de la multiplicación,
longitud vectores y resultados (primer y último componente del resultado para
longitudes mayores que 9))
 *
 * **Compilación**
 * @code
...
if (N < 10) {
  ...
  printf("Tiempo: %11.9f \t Tamaño: %u \t m3[0][0]: %8.6f \t m3[N-1][N-1]: "
         "%8.6f \n",
